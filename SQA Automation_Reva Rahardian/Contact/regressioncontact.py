...
class TestLogin(unittest.TestCase): 
    ...
    def test_a_send_message(self): 
        ...
        time.sleep(1)
        browser.find_element(By.ID,"recipient-email").send_keys("rvrahardian@gmail.com")
        time.sleep(1)
    ...
    def test_a_send_message(self): 
        ...
        browser.find_element(By.ID,"recipient-email").send_keys("")
        time.sleep(1)
        browser.find_element(By.ID,"recipient-name").send_keys("")
        time.sleep(1)
        browser.find_element(By.ID,"message-text").send_keys("")
        time.sleep(1)
        browser.find_element(By.XPATH,"/html/body/div[1]/div/div/div[3]/button[2]").click()
        time.sleep(2)
        response_message = Alert(browser).text
